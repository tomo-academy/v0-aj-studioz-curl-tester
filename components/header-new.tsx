    ...
    <>
      <header className="bg-card border-b border-border px-3 md:px-4 lg:px-6 py-2 md:py-3 lg:py-4 flex items-center justify-between flex-shrink-0">
        ...
        <div className="flex items-center gap-1 md:gap-2 lg:gap-3 flex-shrink-0">
          ...
          <button
            onClick={() => setShowAIChat(true)}
            className="hidden md:flex items-center gap-2 px-2 md:px-3 py-1.5 md:py-2 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg transition-colors font-medium text-xs md:text-sm"
            title="Chat with AI Assistant"
          >
          ...
          <button
            ...
            className="hidden md:flex items-center gap-1 md:gap-2 px-2 md:px-3 py-1.5 md:py-2 bg-secondary hover:bg-secondary/80 text-foreground rounded-lg transition-colors font-medium text-xs md:text-sm border border-border"
          ...
          {/* Copy Link Button - Mobile shows icon only */}
          <button
            onClick={handleCopy}
            className="flex items-center gap-1 md:gap-2 px-2 md:px-3 py-1.5 md:py-2 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg transition-colors font-medium text-xs md:text-sm"
          ...
          >
            ...
            <span className="hidden md:inline lg:inline">Copy</span>
          </button>
        </div>
      </header>
